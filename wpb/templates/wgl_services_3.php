<?php
	...
	// render html
	$output .= '<div '.esc_attr($services_id_attr).' class="integrio_module_services_3'.esc_attr($services_wrap_classes).'">';
		$output .= '<div class="services_wrapper">';
			$output .= '<div class="services_icon_wrapper">';
				if ((bool)$add_circles) {
					...
					// $output .= Integrio_Theme_Helper::hexagon_html($circles_color, true);
					// $output .= Integrio_Theme_Helper::hexagon_html($circles_color_2, true);
				}
