<?php
	...
	$button_icon = (bool)$add_button_arrow ? 'font' : 'none';
	...
	if ((bool)$add_read_more) {
        ...
        $button_options_arr = array(
			...
			'bottom_mar' => '0',
			'bg_gradient_idle_start' => $bg_gradient_idle_start,
			'bg_gradient_idle_end' => $bg_gradient_idle_end,
			'bg_gradient_hover_start' => $bg_gradient_hover_start,
			'bg_gradient_hover_end' => $bg_gradient_hover_end,
			'border_gradient_idle_start' => $bg_gradient_idle_start,
			'border_gradient_idle_end' => $bg_gradient_idle_end,
			'border_gradient_hover_start' => $bg_gradient_hover_start,
			'border_gradient_hover_end' => $bg_gradient_hover_end,
			'icon_type' => $button_icon,
			'icon_pack' => 'flaticon',
			'icon_font_size' => '17',
			'icon_position' => 'right',
			'icon_flaticon' => 'flaticon-right-arrow',
        );
	...
	$services_front .= '<div class="services_front" '.$front_styles.'>';
		...
		$services_front .= !empty($front_descr) ? '<div class="services_descr" '.(!empty($front_descr_color) ? 'style="color:'.esc_attr($front_descr_color).';"' : '').'>'.$front_descr.'</div>' : '';
	$services_front .= '</div>';
	...
	// render html
	$output .= '<div class="integrio_module_services'.esc_attr($services_wrap_classes).'">';
