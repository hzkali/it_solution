...
class Integrio_dynamic_styles{
	...
	public function admin_js_reg(){
		...
		wp_localize_script('wp-color-picker', 'wpColorPickerL10n', [
            'clear' => esc_html__('Clear', 'integrio'),
            'clearAriaLabel' => esc_html__('Clear color', 'integrio'),
            'defaultString' => esc_html__('Default', 'integrio'),
            'defaultAriaLabel' => esc_html__('Select default color', 'integrio'),
            'pick' => esc_html__('Select', 'integrio'),
            'defaultLabel' => esc_html__('Color value', 'integrio'),
        ]);
	    // Colorbox https://gist.github.com/tmcw/6793969
		...
		//Admin Js
        wp_enqueue_script('integrio-admin', $this->gtdu . '/core/admin/js/admin.js');

        if (class_exists( 'RWMB_Loader' )) {
            wp_enqueue_script('integrio-metaboxes', $this->gtdu . '/core/admin/js/metaboxes.js');
        }
        ...
        wp_localize_script('integrio-admin', 'wgl_verify', [
            ...
            'email' => esc_js($email),
            'message' => esc_js(esc_html__( 'Thank you, your license has been validated', 'integrio' )),
